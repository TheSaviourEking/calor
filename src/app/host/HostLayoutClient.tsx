...
import { Plus, LayoutDashboard, Menu, X, ChevronLeft } from 'lucide-react'
  ...
  return (
    <ClientWrapper>
      <div className="min-h-screen bg-cream flex">
        {/* Sidebar */}
        <aside
          className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed lg:static inset-y-0 left-0 z-50 w-64 bg-charcoal transition-transform lg:translate-x-0`}
        >
          <div className="p-6 h-full flex flex-col">
            <div className="flex items-center justify-between mb-8">
              <Link
                href="/host/dashboard"
                className="font-display text-cream text-xl tracking-wider"
