...
export default function AccountClient() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!res.ok) {
                // Special handling for unverified email — show inline banner instead of generic error
        ...
        <div className="min-h-screen bg-cream flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="bg-warm-white/30 backdrop-blur-sm border border-charcoal/5 p-8 rounded-sm">
                    ...
                    {error && (
                        <div className="mb-4 px-4 py-3 border border-ember/30 bg-ember/5">
                    ...
                    {unverifiedEmail && (
                        <div className="mb-6 px-4 py-4 border border-terracotta/30 bg-terracotta/5">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="font-body text-xs text-warm-gray mb-3">
                                        We sent a verification link to <strong className="text-charcoal">{unverifiedEmail}</strong>. Check your inbox (and spam folder).
                                    </p>
                                    {resendSent ? (
                                        <span className="inline-flex items-center gap-1.5 font-body text-xs text-terracotta">
                                        ...
                                        <button
                                            ...
                                            className="inline-flex items-center gap-1.5 font-body text-xs text-terracotta hover:text-terracotta/80 transition-colors underline underline-offset-2 disabled:opacity-50"
                                        >
                                            {resendLoading ? (
